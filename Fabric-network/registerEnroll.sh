...
function createrevenue() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:8054 --caname ca-revenue --tls.certfiles ${PWD}/organizations/fabric-ca/revenue/tls-cert.pem
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-8054-ca-revenue.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-8054-ca-revenue.pem
    OrganizationalUnitIdentifier: peer
  ...
  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-revenue -M ${PWD}/organizations/peerOrganizations/revenue.land.com/peers/peer0.revenue.land.com/msp --csr.hosts peer0.revenue.land.com --tls.certfiles ${PWD}/organizations/fabric-ca/revenue/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-revenue -M ${PWD}/organizations/peerOrganizations/revenue.land.com/peers/peer0.revenue.land.com/tls --enrollment.profile tls --csr.hosts peer0.revenue.land.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/revenue/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:8054 --caname ca-revenue -M ${PWD}/organizations/peerOrganizations/revenue.land.com/users/User1@revenue.land.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/revenue/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://revenueadmin:revenueadminpw@localhost:8054 --caname ca-revenue -M ${PWD}/organizations/peerOrganizations/revenue.land.com/users/Admin@revenue.land.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/revenue/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createbank() {
  ...
  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:6054 --caname ca-bank -M ${PWD}/organizations/peerOrganizations/bank.land.com/peers/peer0.bank.land.com/msp --csr.hosts peer0.bank.land.com --tls.certfiles ${PWD}/organizations/fabric-ca/bank/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:6054 --caname ca-bank -M ${PWD}/organizations/peerOrganizations/bank.land.com/peers/peer0.bank.land.com/tls --enrollment.profile tls --csr.hosts peer0.bank.land.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/bank/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:6054 --caname ca-bank -M ${PWD}/organizations/peerOrganizations/bank.land.com/users/User1@bank.land.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/bank/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://bankadmin:bankadminpw@localhost:6054 --caname ca-bank -M ${PWD}/organizations/peerOrganizations/bank.land.com/users/Admin@bank.land.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/bank/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/land.com/orderers/orderer.land.com/msp --csr.hosts orderer.land.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/land.com/orderers/orderer.land.com/tls --enrollment.profile tls --csr.hosts orderer.land.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/land.com/users/Admin@land.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
